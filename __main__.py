...
if __name__ =='__main__':
    ...
    for item in CONFIG['items']:
        ...
        filename = '%s_%s_%s' % (item['page_name'],item['since'],item['until'])
        visualize.wordcloud(filename,count_m50,CONFIG['common']['result_vidualization_dir'])
        visualize.graph_bar(
            ...
            result_vidualization_dir=CONFIG['common']['result_vidualization_dir']
        )
